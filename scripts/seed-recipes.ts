...
async function main() {
  await prisma.recipe.upsert({
    ...
    create: {
      slug: "mascarpone-pasta", title: "Mascarpone Pasta", summary: "Creamy garlic mascarpone pasta with spinach, nutmeg, and plenty of black pepper.", servings: 1, prepMinutes: 5, cookMinutes: 20, tags: ["pasta"], notes: "Keep the heat gentle once the mascarpone is in the pan so the sauce stays silky.", calories: 1310, proteinGrams: 34, carbsGrams: 158, fatGrams: 66,
      ingredients: { create: [
        { amount: "150", unit: "g", name: "pasta", note: "", optional: false, sortOrder: 0 },
      ...
      steps: { create: [
        "Bring a pot of well-salted water to a boil. Chop the garlic and wash the spinach.", "Cook the pasta until just shy of al dente. Reserve a cup of the pasta water before draining.", "While the pasta cooks, warm the olive oil in a large pan over medium-low heat. Cook the garlic briefly until fragrant, without browning.", "Stir in the mascarpone and a splash of pasta water. Season with salt, black pepper, and a small pinch of nutmeg until smooth.", "Add the spinach and let it wilt. Toss in the pasta, adding more pasta water as needed, until coated and finished cooking in the sauce.", "Serve with extra black pepper, Parmesan, and roasted sunflower seeds if using.",
