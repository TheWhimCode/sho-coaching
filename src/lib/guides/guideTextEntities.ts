...
export const GUIDE_TEXT_ENTITIES: GuideTextEntity[] = [
  ...
  { patterns: ["\\bLDR\\b"], matchKey: "ldr", color: GUIDE_LDR_GRAY, icon: { kind: "item", id: "3036" }, regex: true },
  { patterns: ["\\bIE\\b"], matchKey: "ie", color: GUIDE_KRAKEN_GOLD, icon: { kind: "item", id: "3031" }, regex: true },
  { patterns: ["\\bDD\\b"], matchKey: "dd", color: GUIDE_CONQUEROR_ORANGE, icon: { kind: "item", id: "6333" }, regex: true },
  { patterns: ["\\bGA\\b"], matchKey: "ga", icon: { kind: "item", id: "3026" }, regex: true },
  { patterns: ["\\bQSS\\b"], matchKey: "qss", icon: { kind: "item", id: "3140" }, regex: true },
  {
    patterns: ["\\bvision\\b"],
    matchKey: "vision",
    color: GUIDE_SHIELDBOW_RED,
