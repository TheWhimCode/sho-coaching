...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-[#0B1220] text-white font-sans overflow-hidden">
      {/* VISIBLE, on-top gradient layers (no negative z-index) */}
      <div
        aria-hidden
        className="absolute inset-0 z-0 pointer-events-none"
      >
        {/* Top glow */}
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[120vw] h-[60vh] blur-3xl opacity-80"
             style={{
               background:
        ...
        />
        {/* Right sweep */}
        <div className="absolute bottom-[-20%] right-[-10%] w-[70vw] h-[70vh] blur-3xl opacity-70"
             style={{
               background:
        ...
        />
        {/* Left base */}
        <div className="absolute bottom-0 left-[-15%] w-[60vw] h-[55vh] blur-3xl opacity-70"
             style={{
               background:
      ...
      <main className="relative z-10 grid place-items-center min-h-screen p-8">
