        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-14 md:gap-20 items-center">
            ...
            <div className="relative rounded-2xl border border-white/10 bg-white/[.03] p-8 md:p-10">
              ...
              <div className="grid grid-cols-3 gap-4">
                {["#f6e9b3", "#a6c8ff", "#f6b1b1"].map((c, i) => (
                  <div
                    key={i}
                    className="aspect-[4/5] rounded-xl border border-white/10 bg-white/[.05] relative overflow-hidden"
                  >
                    <div className="absolute inset-x-0 top-0 h-12" style={{ backgroundColor: c, opacity: 0.2 }} />
                    <div className="absolute inset-x-0 top-14 space-y-3 px-4">
              ...
              <div className="mt-8 text-sm text-white/60">Examples: notes, checkpoints, quick clips.</div>
              <div
                className="absolute -left-6 -top-6 h-32 w-32 rounded-3xl -rotate-12 opacity-20"
          ...
          <div className="md:col-span-6 order-first md:order-last">
            ...
            <p className="mt-4 text-white/70">
              What exactly is a follow-up? Is it worth it?
            </p>
