...
export default function StepQuickChampion({
  champion,
  onChampionChange,
  champion2,
  onChampion2Change,
  ...
  React.useEffect(() => {
    setFooterState({
      ...
      onPrimary: () => onNextRef.current?.(),
      secondaryLabel: "Back",
      secondaryDisabled: false,
      onSecondary: () => goBackRef.current?.(),
    });
    return () => setFooterState(null);
    // Only run on mount/unmount; callbacks read from refs
  ...
  return (
    <div className="h-full min-h-0">
      <div className="h-full min-h-0 px-2 sm:px-4">
        <div className="h-full min-h-0 mx-auto w-full max-w-[400px] md:pt-20 flex flex-col">
          <div className="mb-3">
