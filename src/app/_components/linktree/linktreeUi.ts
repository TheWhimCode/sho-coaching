...
export const LINKTREE_BUTTON_INNER =
  "group relative z-10 flex w-full items-center gap-2.5 px-3 py-3 sm:gap-3 sm:px-3.5 sm:py-3.5 md:px-4 md:py-4 lg:px-5 lg:py-4";
...
export const LINKTREE_SHELL =
  "relative block w-full overflow-hidden rounded-2xl border border-white/10 bg-[#0B1220]/55 backdrop-blur-md outline-none transition-[border-color,box-shadow] duration-300 focus-visible:ring-2 focus-visible:ring-[var(--link-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050B18] hover:border-[color-mix(in_srgb,var(--link-accent)_45%,transparent)] hover:shadow-[0_0_0_1px_color-mix(in_srgb,var(--link-accent)_35%,transparent),0_12px_40px_-8px_var(--link-glow),0_0_48px_-12px_var(--link-glow)]";
